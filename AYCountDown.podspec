...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Andrew Yang"
  # s.authors            = { "Andrew Yang" => "evil_eve_live@outlook.com" }
  # s.social_media_url   = "http://twitter.com/Andrew Yang"
  ...
  # s.public_header_files = "AYCountDown/library/*.h"
